...
class RemindersLocalRepository(
    ...
    override suspend fun getReminders(): com.udacity.project4.locationreminders.data.dto.Result<List<ReminderDTO>> = withContext(ioDispatcher) {
        return@withContext try {
            com.udacity.project4.locationreminders.data.dto.Result.Success(remindersDao.getReminders())
        } catch (ex: Exception) {
    ...
    override suspend fun    getReminder(id: String): com.udacity.project4.locationreminders.data.dto.Result<ReminderDTO> = withContext(ioDispatcher) {
        try {
            ...
            if (reminder != null) {
                return@withContext com.udacity.project4.locationreminders.data.dto.Result.Success(reminder)
            } else {
                return@withContext com.udacity.project4.locationreminders.data.dto.Result.Error("Reminder not found!")
            }
        } catch (e: Exception) {
            return@withContext com.udacity.project4.locationreminders.data.dto.Result.Error(e.localizedMessage)
        }
    }
